/* ------------------------------------------------------------------
   Ryder — seed data used to populate the database on first run.
   All seed accounts share the password below so you can sign in as
   any of them to explore (e.g. handle "jackp", password "golf").
------------------------------------------------------------------ */
const SEED_PASSWORD = "golf";
...
const societies = [
  {
    id: "soc1", name: "The Sunday Hackers Society", handle: "sundayhackers", loc: "North Devon", colour: "green",
    ...
    founded: "2018", members: ["p1","p2","p3","p4","p5","p6","p7","p8","p9","p10","p11","p12","p15"],
    honours: [
  ...
  {
    id: "soc2", name: "Burnt Toast Golf Club", handle: "burnttoast", loc: "Bideford", colour: "amber",
    about: "Mates who met on a stag do and never stopped. Monthly roll-ups and one big away day. New players always wanted.",
    founded: "2021", members: ["p7","p10","p13","p16"],
    honours: [{ year: "2025", event: "The Toast Cup", winner: "The Crumbs", score: "8½ – 7½" }],
  },
  {
    id: "soc3", name: "Fairway Friday League", handle: "fairwayfriday", loc: "Exeter", colour: "violet",
    about: "After-work fourballs every Friday and a team matchplay season. Sociable, competitive, dog-friendly clubhouse.",
    founded: "2019", members: ["p8","p11","p14"], honours: [],
  },
  {
    id: "soc4", name: "Saunton Seniors", handle: "sauntonseniors", loc: "Saunton", colour: "blue",
    about: "The over-55s of Saunton GC. Tuesday medals and an annual Ryder-style match against Royal North Devon.",
    founded: "2009", members: ["p4","p12","p16"],
    honours: [{ year: "2025", event: "Coast Cup", winner: "Saunton", score: "15 – 9" }],
  },
];

const events = [
  {
    id: "ev1", title: "The Heathland Cup", societyId: "soc1", venue: "Saunton GC — East Course",
    date: "Sat 13 June 2026", status: "live", capacity: 12,
    ...
    sessions: [
      { id: "s1", name: "Friday Fourballs", format: "Fourball (better ball)", blurb: "Pairs play their own ball — lowest score wins the hole.",
        matches: [
      ...
      { id: "s2", name: "Saturday Foursomes", format: "Foursomes (alternate shot)", blurb: "One ball per pair, taking turns to play each shot.",
        matches: [
      ...
      { id: "s3", name: "Sunday Singles", format: "Singles match play", blurb: "Everyone out — one-on-one, a point on the line for each.",
        matches: [
  ...
  {
    id: "ev2", title: "Autumn Foursomes Day", societyId: "soc1", venue: "Royal North Devon GC",
    date: "Sat 19 Sept 2026", status: "upcoming", capacity: 16,
  ...
  {
    id: "ev3", title: "The Toast Cup — open day", societyId: "soc2", venue: "Libbaton GC",
    date: "Sun 5 July 2026", status: "open", capacity: 12,
    attendees: ["p7","p10","p13","p16"], formats: ["Fourballs", "Singles"],
    note: "Looking for 8 more players to make up the teams — all welcome, come and meet the crew.",
  },
];

// minutes-ago offsets keep the feed ordering and relative times sensible
const feed = [
  { id: "f1", type: "event", authorSociety: "soc1", eventId: "ev2", agoMin: 120,
    ...
    reactions: { "🔥": 12, "⛳": 7, "👍": 5 },
    comments: [ { by: "p3", text: "In. Already booked the Friday off 😎", agoMin: 60 }, { by: "p6", text: "Same partnership as last year?", agoMin: 44 } ] },
  { id: "f2", type: "result", authorSociety: "soc1", agoMin: 1500,
    ...
    reactions: { "🏆": 21, "🔥": 9, "👍": 6 }, comments: [ { by: "p7", text: "Rematch at the Heathland Cup. You're going down 😉", agoMin: 1200 } ] },
  { id: "f3", type: "photo", authorGolfer: "p3", agoMin: 2880, tint: "green", caption: "Saunton East looking unreal this morning",
    text: "Best day's golf in ages with the Sunday Hackers. This is why we do it ⛳️",
    reactions: { "⛳": 18, "🔥": 11, "👍": 4 }, comments: [ { by: "p15", text: "That 17th green 😍", agoMin: 1440 }, { by: "p1", text: "Carry me round next time", agoMin: 1400 } ] },
  { id: "f4", type: "event", authorSociety: "soc2", eventId: "ev3", agoMin: 4320,
    ...
    reactions: { "👍": 8, "⛳": 5 }, comments: [ { by: "p13", text: "Tell your mates, the more the merrier 🍞", agoMin: 2880 } ] },
  { id: "f5", type: "join", authorGolfer: "p15", societyId: "soc1", agoMin: 5760,
    text: "joined The Sunday Hackers Society.", reactions: { "👋": 14, "👍": 3 }, comments: [] },
];

module.exports = { SEED_PASSWORD, golfers, societies, events, feed };
