...
window.RYDER_SEED = {
  ...
  events: [
    {
      ...
      sessions: [
        {
          id: "s1", name: "Morning Fourballs", format: "Fourball (better ball)",
        ...
        {
          id: "s2", name: "Afternoon Singles", format: "Singles match play",
          blurb: "Everyone back out one-on-one — a point on the line in each.",
          matches: [
            { blue: ["p1"], red: ["p7"],  status: "final", winner: "blue", margin: "3 & 2" },
            { blue: ["p3"], red: ["p10"], status: "live",  winner: null,   thru: 14, state: "Azure 2 up" },
            { blue: ["p6"], red: ["p8"],  status: "live",  winner: null,   thru: 12, state: "All square" },
            { blue: ["p2"], red: ["p12"], status: "final", winner: "red",  margin: "1 up" },
            { blue: ["p5"], red: ["p11"], status: "soon", winner: null, tee: "13:40" },
            { blue: ["p4"], red: ["p9"],  status: "soon", winner: null, tee: "13:50" },
          ],
        },
      ],
    },
  ...
  courses: [
    { id: "c1", name: "Saunton Golf Club", match: "Saunton", town: "Braunton", type: "Links",
      ...
      booking: { contact: "Hannah Reeve", role: "Society Coordinator", phone: "01271 812436", email: "societies@sauntongc.co.uk", rate: 78, deposit: 250, minGroup: 8, lead: "8 weeks", days: "Weekdays & Sun afternoons", catering: "Bacon rolls on arrival, two-course meal after" } },
    { id: "c2", name: "Royal North Devon", match: "Royal North Devon", town: "Westward Ho!", type: "Links",
      ...
      booking: { contact: "Iain Mortimer", role: "Club Secretary", phone: "01237 473817", email: "secretary@royalnd.co.uk", rate: 70, deposit: 200, minGroup: 8, lead: "6 weeks", days: "Mon/Wed/Fri & weekend pm", catering: "Clubhouse carvery" } },
    { id: "c3", name: "Ilfracombe Golf Club", match: "Ilfracombe", town: "Ilfracombe", type: "Clifftop",
      ...
      booking: { contact: "Sue Bellamy", role: "Society Bookings", phone: "01271 862050", email: "bookings@ilfracombegc.co.uk", rate: 42, deposit: 100, minGroup: 8, lead: "4 weeks", days: "Most days", catering: "Sandwiches or hot food by arrangement" } },
    { id: "c4", name: "Libbaton Golf Club", match: "Libbaton", town: "Umberleigh", type: "Parkland",
      ...
      booking: { contact: "Dave Stagg", role: "Pro Shop", phone: "01769 560269", email: "shop@libbatongolf.co.uk", rate: 38, deposit: 100, minGroup: 8, lead: "3 weeks", days: "Seven days", catering: "Full menu, lodges on site" } },
    { id: "c5", name: "Great Torrington", match: "Torrington", town: "Torrington", type: "Heathland",
      ...
      booking: { contact: "The Steward", role: "Hon. Secretary", phone: "01805 622229", email: "info@greattorringtongc.co.uk", rate: 22, deposit: 50, minGroup: 6, lead: "2 weeks", days: "Most days exc. comp Sundays", catering: "Bar snacks" } },
    { id: "c6", name: "Holsworthy Golf Club", match: "Holsworthy", town: "Holsworthy", type: "Parkland",
      ...
      booking: { contact: "Margaret Cole", role: "Society Secretary", phone: "01409 253177", email: "secretary@holsworthygc.co.uk", rate: 30, deposit: 75, minGroup: 8, lead: "3 weeks", days: "Weekdays & weekend pm", catering: "Two-course meal option" } },
  ],
};
